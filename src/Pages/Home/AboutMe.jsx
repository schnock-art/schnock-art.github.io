    ...
    <section id="AboutMe" className="about--section">
      ...
      <div className="hero--section--content--box about--section--box">
        <div className="hero--section--content">
          ...
          I am a seasoned Data Scientist and Engineer, holding a Master's Degree in Data and Information Science. My professional journey includes a notable tenure at Merkur Innovation Lab in Graz, Austria, where I excelled in data warehouse design, ETL processes, and predictive modeling. Prior to this, at Tiendanube S.A. in Buenos Aires, I automated key reports and enhanced data-driven decision-making. My career also includes impactful work as a Reservoir Engineer at Schlumberger, where I combined technical expertise with client relationship management.
          </p>
          <p className="hero--section-description">
